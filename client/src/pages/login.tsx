...
export default function Login() {
  ...
  const handleSocialLogin = async (provider: string) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Welcome to Whats the Move!",
      });
      
      // For new users from social login, go to onboarding
  ...
  const handleGuestAccess = () => {
    toast({
      ...
      description: "You can explore events without an account!",
    });
            ...
            <div className="mt-4 space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  disabled={isLoading}
                  className="w-full inline-flex justify-center py-3 px-4 rounded-lg border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors disabled:opacity-50"
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-lg border border-gray-300 bg-white text-sm font-medium text-gray-500 hover:bg-gray-50 transition-colors"
